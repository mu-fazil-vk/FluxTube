...
part of 'trending_resp.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

TrendingResp _$TrendingRespFromJson(Map<String, dynamic> json) => TrendingResp(
...
Map<String, dynamic> _$TrendingRespToJson(TrendingResp instance) =>
    <String, dynamic>{
      'url': instance.url,
      'type': instance.type,
